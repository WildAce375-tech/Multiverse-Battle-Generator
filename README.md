# CLEAN REPOSITORY PACKAGE — v3.0

This package intentionally contains one folder only:

`multiverse-battle-generator/`

Put these files inside the existing GitHub folder with that exact name.
Render should keep:

- Root Directory: `multiverse-battle-generator`
- Dockerfile Path: `./Dockerfile`

Do not create a second copy of these files at the repository root.
